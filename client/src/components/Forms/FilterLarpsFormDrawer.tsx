...
import FilterLarpsForm from "./FilterLarpsForm";
import { base64Decode, base64Encode } from "../../util/utilities";
import { useCallback, useMemo } from "react";

type FilterLarpsFormDrawerProps = {
  onSubmitCallback: ()=> void;
}

function FilterLarpsFormDrawer({onSubmitCallback}:FilterLarpsFormDrawerProps) {
...
export default FilterLarpsFormDrawer;